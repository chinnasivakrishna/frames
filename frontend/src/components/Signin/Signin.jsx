...
const LoginForm = () => {
  ...
  const login = async (e) => {
    ...
    try {
      const response = await axios.post("https://frames-api-tau.vercel.app/user/login", data);
    ...
    <div className="login-form">
      ...
      <form className="login-form__form" onSubmit={login}>
        <div className="login-form__input-box">
          <input type="text" placeholder="Username" required className="login-form__input" name="userEmail" value={data.userEmail} onChange={handleChange} />
          <i className='bx bxs-user login-form__icon'></i>
        </div>
        <div className="login-form__input-box">
          <input type="password" placeholder="Password" required className="login-form__input" name="userPassword" value={data.userPassword} onChange={handleChange} />
